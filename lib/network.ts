...
export interface NetworkState {
  ...
  // === Result States ===
  // Specifies the type of result produced ("chart" or "component" or "conversation")
  result_type?: "chart" | "component" | "chart_selection" | "conversation";
 ...
 * - Slack Agent: Manages Slack workspace information and conversation history
...
export const assistantNetwork = createNetwork<NetworkState>({
  ...
  agents: [chartAgent, slackAgent, chartPickerAgent, bemDataCleanerAgent, dataAgent, uiAgent],
